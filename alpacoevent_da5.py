...
st.set_page_config(page_title="[하나은행] Digital Hana 路 데이터분석/서비스기획 5기 <br> 크리스마스 이벤트", layout="wide")
...
<head>
    ...
    <title>[하나은행] Digital Hana 路 데이터분석/서비스기획 5기 <br> 크리스마스 이벤트</title>
    <style>
...
<body>
    <div class="container">
        <h2 class="title">[하나은행] Digital Hana 路 데이터분석/서비스기획 5기 <br> 크리스마스 이벤트</h2>

...
st.set_page_config(page_title="[하나은행] Digital Hana 路 금융서비스개발 5기 - 크리스마스 이벤트", layout="wide")
...
<head>
    ...
    <title>[하나은행] Digital Hana 路 금융서비스개발 5기 - 크리스마스 이벤트</title>
    <style>
...
<body>
    <div class="container">
        <h2 class="title">[하나은행] Digital Hana 路 금융서비스개발 5기 - 크리스마스 이벤트</h2>
